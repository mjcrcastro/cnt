    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md">
                        <a class="btn btn-block text-nowrap btn-primary" href="{{ route('exchangerates.create')}}" role="button">Nuevo  
                    ...
                    <div  class="col-md">
                        <a id="editExchangeRate" class="btn btn-block text-nowrap btn-disabled" href="#" role="button">Editar
                            <svg class="bi" width="24" height="24" fill="currentColor">
                            <use xlink:href="/vendor/bootstrap/img/bootstrap-icons.svg#pencil-square"/>
                            </svg>
                        </a>
                    </div>
                    <div id ="deleteExchangeRate" class="col-md">
        ...
        <div class="card-body">
            <div class="table-responsive-sm">
                <table class="table table-striped table-bordered" id="exchangeRatesTable" width="100%" cellspacing="0">
                    <thead>
                        <tr >
                            <th></th>
                            <th>Fecha</th>
...
$(document).ready(function () {
    var editButton = $('#editExchangeRate');
    var deleDiv = $('#deleteExchangeRate');
    ...
    table //here we change 
            .on('select', function (e, dt, type, indexes) {
                ...
                editButton.attr('href', '/exchangerates/' + rowData[0]['id'] + '/edit');
                editButton.addClass('btn-primary');
                editButton.removeClass('btn-disabled');

                deleDiv.html('<form method="POST" action="/countries/' + rowData[0]['id'] + '" accept-charset="UTF-8">' +
